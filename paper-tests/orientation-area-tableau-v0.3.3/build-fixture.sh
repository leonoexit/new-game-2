...
KIT="$ROOT/paper-tests/orientation-area-tableau-v0.3.3"
CARDS="$KIT/cards"
BOARDS="$KIT/boards"
...
make_target "$SEARCH_ART" search-side-tunnel 'SEARCH SIDE TUNNEL' '#705677' '-1 AP' 'DEPTH +0' '' 'REVEAL AN ORE SOURCE'
...
magick -size 1000x4950 xc:'#fff8df' \
  ...
  -fill '#fff8df' -font "$FONT_BOLD" -pointsize 30 -gravity north -annotate +0+12 'WORLD STRIP v0.3.3 · ABSTRACT AREA TABLEAUS' \
