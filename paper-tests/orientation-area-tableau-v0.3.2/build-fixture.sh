...
KIT="$ROOT/paper-tests/orientation-area-tableau-v0.3.2"
...
magick -size 1000x4950 xc:'#fff8df' \
  ...
  -fill '#fff8df' -font "$FONT_BOLD" -pointsize 30 -gravity north -annotate +0+12 'WORLD STRIP v0.3.2 · ABSTRACT AREA TABLEAUS' \
  ...
  -stroke '#6d8154' -strokewidth 4 -draw 'line 88,1200 912,1200' \
  -fill '#425e50' -stroke none -font "$FONT_BOLD" -pointsize 20 -gravity northwest -annotate +88+1220 'FARM STATE · 2 / 4 PLOTS ACTIVE · WATERED TODAY' \
  -fill '#68776f' -font "$FONT_BOLD" -pointsize 14 -annotate +88+1258 'READ ONLY · PERSISTS OFF-SCREEN · NO INTERACTION' \
  ...
  -stroke '#b85f3e' -strokewidth 4 -draw 'line 88,2195 912,2195' \
  -fill '#754838' -stroke none -font "$FONT_BOLD" -pointsize 20 -gravity northwest -annotate +88+2215 'MARKET STATE · OPEN · ALL RESULTS PREVIEWED' \
  -fill '#8c6655' -font "$FONT_BOLD" -pointsize 14 -annotate +88+2253 'READ ONLY · NO COMMERCE-WIDE TARGET' \
  ...
  -stroke '#39786f' -strokewidth 4 -draw 'line 88,3235 912,3235' \
  -fill '#2c625b' -stroke none -font "$FONT_BOLD" -pointsize 20 -gravity northwest -annotate +88+3255 'FISH RECORD · MINNOW 1 / 2' \
  -fill '#4d736c' -font "$FONT_BOLD" -pointsize 14 -annotate +88+3293 'READ ONLY · PERSISTS OFF-SCREEN · NO INTERACTION' \
  ...
  -fill '#3f514b' -stroke none -font "$FONT_BOLD" -pointsize 20 -gravity northwest -annotate +88+3820 'MINE STATE · DEPTH 3 · NEXT CHECKPOINT IN 3' \
  -fill '#68746f' -font "$FONT_BOLD" -pointsize 14 -annotate +88+3858 'READ ONLY · PERSISTS THROUGH SCROLL AND SLEEP' \
