...
The exact AP values below are **Little Valley Cards** paper costs, not rules attributed to either Stardew game. Area grouping and visual stacks do not determine how many crops an action affects; [action granularity test 01](ACTION-GRANULARITY-PAPER-TEST-01.md) already rejected that shortcut.
