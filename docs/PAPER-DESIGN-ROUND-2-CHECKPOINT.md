...
| File | Scope | Verdict |
| --- | --- | --- |
| [Content-minimum registry 01](CONTENT-MINIMUM-REGISTRY-01.md) | Shared crops/items/sources/Projects/collection/Processing vocabulary | Complete as fixture vocabulary |
...
| [Year 1 graph v1](YEAR-1-PROGRESSION-DEPENDENCY-GRAPH-V1.md) | Integrated state/reveal dependency graph | Complete as v1 hypothesis graph |
