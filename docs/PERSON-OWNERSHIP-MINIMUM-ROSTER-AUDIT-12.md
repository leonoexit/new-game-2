...
Owner confirmation 2026-09-24: after the requested review in [package v1 §7.4](YEAR-1-PAPER-DESIGN-PACKAGE-V1.md), the owner said “ok chốt”. **R3 remains the historical owner choice, but is withdrawn as the first-playable minimum.** Nell alone is active in that paper scope; Mira/Bram remain canonical names for later content. The comparison and decision record below describe the earlier choice, not today's playable roster.
