...
Nguồn: [quyết định Person/Heart](NPC-HEART-DESIGN-DECISIONS.md), [roster R3](PERSON-OWNERSHIP-MINIMUM-ROSTER-AUDIT-12.md), [kernel audit](PERSON-ROSTER-KERNEL-AUDIT-02.md), [registry](../current/CONTENT-MINIMUM-REGISTRY-01.md), [Q4](PROJECT-QUANTITY-WORK-A6-S18-RERUN-04.md), [farm/Seed route 30](FIRST-PLAYABLE-SEED-SELL-PRICE-PAPER-TEST-30.md), [Heart test 32](FIRST-PLAYABLE-HEART-GIFT-CADENCE-PAPER-TEST-32.md), [PJ-X test 31](FIRST-PLAYABLE-PJ-X-MATERIAL-WORK-PAPER-TEST-31.md).
