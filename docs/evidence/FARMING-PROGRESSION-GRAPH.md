...
Cập nhật 2026-09-24: F9 dưới đây từng giả định cần một Project để giảm công tưới; cả ba Project đề xuất sau đó đã bị bác bỏ. [Farm action grammar và AP rerun 41](../current/FIRST-PLAYABLE-FARM-ACTION-GRAMMAR-AP-RERUN-41.md) là luật giấy hiện hành cho Watering Can, Rain, Sleep growth và Hand Harvest. F9 vẫn là câu hỏi lịch sử về cảm giác thao tác, không phải một Project/upgrade đã chọn.
