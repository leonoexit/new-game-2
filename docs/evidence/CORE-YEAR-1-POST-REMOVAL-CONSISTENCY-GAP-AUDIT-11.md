...
| --- | --- | --- |
| [Year 1 package v1](../current/YEAR-1-PAPER-DESIGN-PACKAGE-V1.md) | Explicitly removes premiums/orders and excludes Processor from minimum economy | Pass; no active dependency found |
| [Dependency graph v1](../current/YEAR-1-PROGRESSION-DEPENDENCY-GRAPH-V1.md) overview | Still drew `Processor PR0` as a current rejoin branch | Corrected to inactive conditional compatibility |
...
| [Content-minimum registry 01](../current/CONTENT-MINIMUM-REGISTRY-01.md) | Header now marks Processing-utility requirements historical; transform templates remain compatibility fixtures |
