...
Trạng thái: paper sensitivity nối [Economy ledger v2](ECONOMY-LEDGER-V2-PAPER-SENSITIVITY-01.md) với [Content-minimum registry 01](../current/CONTENT-MINIMUM-REGISTRY-01.md). Mọi capacity, horizon và spoil rule dưới đây là `[FIXTURE]`; không chốt inventory system.
