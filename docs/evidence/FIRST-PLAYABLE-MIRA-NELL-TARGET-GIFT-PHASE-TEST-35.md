...
Sources: [Person/Heart decisions](NPC-HEART-DESIGN-DECISIONS.md), [mini-roster fixture](PERSON-MINI-ROSTER-FIXTURE-01.md), [kernel audit](PERSON-ROSTER-KERNEL-AUDIT-02.md), [resource-area simulation](RESOURCE-AREA-PAPER-SIMULATION-01.md), [content registry](../current/CONTENT-MINIMUM-REGISTRY-01.md), [exact River/Mine tableau](../current/MINE-FISHING-AREA-TABLEAU-CONTRACT-01.md), [Fishing resolution](FISHING-RESOLUTION-SENSITIVITY-02.md), [corrected all-Sunny farm route](FIRST-PLAYABLE-SEED-SELL-PRICE-PAPER-TEST-30.md), [Seasonal Weather test](FIRST-PLAYABLE-SEASONAL-WEATHER-RNG-PAPER-TEST-28.md).
