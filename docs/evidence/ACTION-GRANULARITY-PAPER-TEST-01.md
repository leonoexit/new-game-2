...
Later Farm resolution 2026-09-24: [rerun 41](../current/FIRST-PLAYABLE-FARM-ACTION-GRAMMAR-AP-RERUN-41.md) uses the existing Watering Can on one Growing Crop for 1 AP and the Hand on one Mature Crop for 1 AP as a working first-playable paper rule. The upgrade/automation possibilities below remain old comparisons; no Water Trough, Harvest Bench or replacement relief has been selected.
