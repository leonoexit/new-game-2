...
> **SUPERSEDED — 2026-09-22.** Tài liệu này vẫn giả định world là một spatial surface/map. Clarification mới nhất xác định scroll chỉ là navigation UI qua các Area tableau trừu tượng, không phải movement hoặc geography. Direction hiện hành nằm ở [Scrollable area-tableau model 08](../current/SCROLLABLE-AREA-TABLEAU-MODEL-08.md). Giữ file này làm audit trail.
