...
| Package/graph | Next-evidence order updated | [Package v1](../current/YEAR-1-PAPER-DESIGN-PACKAGE-V1.md), [graph v1](../current/YEAR-1-PROGRESSION-DEPENDENCY-GRAPH-V1.md) |
