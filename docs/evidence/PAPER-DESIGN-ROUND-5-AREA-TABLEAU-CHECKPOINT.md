...
| --- | --- | --- |
| World presentation | Spatial model retired; vertical abstract Area strip adopted | [Model 08](../current/SCROLLABLE-AREA-TABLEAU-MODEL-08.md) |
| Fishing | Face-up exact Catch + informed atomic commitment + record/mastery | [Mine/Fishing contract 01](../current/MINE-FISHING-AREA-TABLEAU-CONTRACT-01.md) |
| Mine | Persistent state + separate progress/discovery/extraction actions | [Mine/Fishing contract 01](../current/MINE-FISHING-AREA-TABLEAU-CONTRACT-01.md) |
| Card shape | Square 1:1 on-table cards; rectangle reserved for focus/detail UI; status kept as strips | [decision 09](../current/ON-TABLE-CARD-SHAPE-DECISION-09.md) |
...
| Redundant gateways | Fishing Spot/Entrance only remain when they have their own verb/state | [Model 08](../current/SCROLLABLE-AREA-TABLEAU-MODEL-08.md) |
