...
## 8. Mã tham khảo đã lưu

Các đường dẫn dưới đây là ví dụ triển khai trong dự án đã dừng; không cần mang theo luật farming khi tái sử dụng UI.

- [views.js](../prototype/little-valley-cards-mvp/views.js): dựng mặt bài, chồng bài, nhóm và khay tay.
- [styles.css](../prototype/little-valley-cards-mvp/styles.css): bố cục, chữ phủ hình, viền và hiệu ứng. Phần override cuối file chứa cách trình bày full-art mới nhất; đầu file còn CSS của mẫu cũ.
- [gestures.js](../prototype/little-valley-cards-mvp/gestures.js): vòng đời cử chỉ độc lập với luật game.
- [pointer-input.js](../prototype/little-valley-cards-mvp/pointer-input.js): kéo, hit-test, preview và hủy.
- [interactions.js](../prototype/little-valley-cards-mvp/interactions.js): ánh xạ nguồn/đích sang hành động và kết quả.
- [app.js](../prototype/little-valley-cards-mvp/app.js): điều phối lưu, chuyển ngữ cảnh và phản hồi kết quả.
