...
- Dùng [bản đồ nguồn luật](docs/current/README.md) để tìm contract sở hữu từng cơ chế và [danh mục lá V0](docs/current/LITTLE-VALLEY-CARD-REGISTER-V0.xlsx) cho identity, loại, nơi và vai trò. Không tự suy nguồn chuẩn từ tên thư mục hay tên file.
